        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <Link href="#" aria-label="Facebook" className="text-[#38738c] hover:text-[#1d5875]">FB</Link>
              <Link href="#" aria-label="Instagram" className="text-[#38738c] hover:text-[#1d5875]">IG</Link>
              <Link href="#" aria-label="Twitter" className="text-[#38738c] hover:text-[#1d5875]">X</Link>
              <Link href="#" aria-label="YouTube" className="text-[#38738c] hover:text-[#1d5875]">YT</Link>
            </div>
          </div>
