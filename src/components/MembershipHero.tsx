...
const MembershipHero = () => {
	return (
		<section
			...
			style={{
				background: "linear-gradient(to right, #8ccbe5, #b56c4d)",
			}}
		>
				...
				<div className="text-center">
					...
					<div className="mb-12 animate-fade-in-up animation-delay-400">
						...
						<p className="text-lg sm:text-xl text-white/85 max-w-3xl mx-auto leading-relaxed">
							Connect with leading eye care professionals from around the world
							and advance your career in ophthalmology
						</p>
					</div>
