      ...
      courses: [
        {
          ...
          sessions: [
            { time: '10:30 - 10:38', title: 'A Persistent Acute Angle Closure Crisis', speaker: 'Leon Au' },
            { time: '10:38 - 10:46', title: 'Advanced OAG with Unhealthy Conjunctive: What to Do?', speaker: 'Luis Pinto' },
            { time: '10:46 - 10:54', title: 'Discussion', speaker: '' },
            { time: '10:54 - 11:02', title: 'Uncontrolled NVG Following CRVO with a Useful Vision. What is the Plan?', speaker: 'Paul Singh' }
          ]
        },
        {
          id: 'cornea-refractive',
          title: 'Cornea & Refractive: Answers to Common Questions in Our Practice',
          room: 'Room 2',
          timeSlot: '9:30 AM - 10:30 AM',
          moderator: 'Dr. Ahmed Hassan',
          panelists: ['Dr. Lisa Wang', 'Dr. James Miller'],
          sessions: [
            { time: '9:30 - 9:38', title: 'Advanced Corneal Techniques', speaker: 'Dr. Ahmed Hassan' },
            { time: '9:38 - 9:46', title: 'Refractive Surgery Updates', speaker: 'Dr. Lisa Wang' },
        ...
        },
        {
          ...
          sessions: [
            { time: '9:30 - 9:38', title: 'Complex Glaucoma Cases', speaker: 'Dr. Robert Kim' },
            { time: '9:38 - 9:46', title: 'Treatment Decision Making', speaker: 'Dr. Maria Santos' },
            { time: '9:46 - 9:54', title: 'Interactive Discussion', speaker: '' }
          ]
        }
      ]
    }
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-[#2e5e73] to-[#38738c]">
                    ...
                    {rooms.map((room) => (
                      <th key={room} className="px-6 py-4 text-center text-sm font-semibold text-white min-w-[250px]">
                        {room}
                      </th>
                    ))}
                  </tr>
                    ...
                    return (
                      <tr key={timeSlot} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                        ...
                        {scheduleItem?.general ? (
                          <td colSpan={rooms.length} className="px-6 py-4 text-center">
                          ...
                          rooms.map((room, roomIndex) => {
                            ...
                            return (
                              <td key={room} className="px-4 py-4 border-r border-gray-200">
                                {course ? (
                                  <button
                          ...
                          rooms.map((room) => (
                            <td key={room} className="px-6 py-4 border-r border-gray-200">
                              {/* Empty cell */}
                            </td>
                          ))
                        )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSearchFilters(prev => ({ ...prev, track: e.target.value }))}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#38738c] focus:border-transparent"
                  >
                    <option value="all">All</option>
            ...
            <div className="p-6">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <p><span className="font-medium">Moderator:</span> {selectedCourse.moderator}</p>
                  <p><span className="font-medium">Panelists:</span> {selectedCourse.panelists.join(' | ')}</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {selectedCourse.sessions.map((session, index) => (
                  <div key={index} className="border-l-4 border-[#38738c] pl-4 py-2">
